        ...
        <form class="d-none d-md-inline-block me-auto">
          <div class="input-group input-group-merge">
           ...
           <!--  <input
            ...
            <!-- Button -->
         <!--    <span
              class="input-group-text bg-light-green border-light-green p-0"
            > -->
              <!-- Button -->
              <!-- <button
                class="btn btn-primary rounded-2 w-30px h-30px p-0 mx-1"
                type="button"
                ...
                <a href="javascript: void(0);" class="dropdown-item active">
                  <span class="avatar avatar-circle avatar-xxs"
                    ><img
                      ...
                      width="18"
                      height="18" /></span
                  ><span class="text-truncate ms-2">English (US)</span>
                </a>
              </li>
              <li>
                <a href="javascript: void(0);" class="dropdown-item">
                  <span class="avatar avatar-circle avatar-xxs"
                    ><img
                      ...
                      width="18"
                      height="18" /></span
                  ><span class="text-truncate ms-2">English (UK)</span>
                </a>
              </li>
              <li>
                <a href="javascript: void(0);" class="dropdown-item">
                  <span class="avatar avatar-circle avatar-xxs"
                    ><img
                      ...
                      width="18"
                      height="18" /></span
                  ><span class="text-truncate ms-2">Español</span>
                </a>
              </li>
              <li>
                <a href="javascript: void(0);" class="dropdown-item">
                  <span class="avatar avatar-circle avatar-xxs"
                    ><img
                      ...
                      width="18"
                      height="18" /></span
                  ><span class="text-truncate ms-2">Française</span>
                </a>
              </li>
              <li>
                <a href="javascript: void(0);" class="dropdown-item">
                  <span class="avatar avatar-circle avatar-xxs"
                    ><img
                      ...
                      width="18"
                      height="18" /></span
                  ><span class="text-truncate ms-2">Deutsch</span>
                </a>
              </li>
              <li>
                <a href="javascript: void(0);" class="dropdown-item">
                  <span class="avatar avatar-circle avatar-xxs"
                    ><img
                      ...
                      width="18"
                      height="18" /></span
                  ><span class="text-truncate ms-2">中文 (繁體)</span>
                </a>
              </li>
            </ul>
          </div>
 -->
          ...
          <!-- Button -->
          <a
            class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px position-relative link-secondary"
          ...
          >
            <div class="offcanvas-header px-5">
              <h3 class="offcanvas-title" id="offcanvasNotificationsLabel">
                Notificaciones
              </h3>
              ...
              <div class="d-flex align-items-start">
                <div class="dropdown">
                  <a
                    href="javascript: void(0);"
                    class="dropdown-toggle no-arrow w-20px h-20px me-2 text-body"
                    role="button"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
              ...
              <div class="list-group list-group-flush">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Not sure if we'll need any further instruction on how
                          to utilise the encoded ID in links from the new email
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >This is a notice that an invoice has been generated
                          on 05/14/2022.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Hi everyone, thanks to all who have already signed
                          and contributed to Ellie's leaving card.</small
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Let's see how your emails performed in the past
                          week.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >I wanted to introduce Alan to you all, who starts
                          today in the Operations Team as our new Global Payroll
                          &amp; Benefits Manager.</small
                        >
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div class="d-flex">
                    <div class="avatar avatar-circle avatar-xs me-2">
                      <img
                        src="https://d33wubrfki0l68.cloudfront.net/9f5880fc99a40d5021e5a133fe72f232e3883d3a/c965d/assets/images/profiles/profile-13.jpeg"
                        alt="..."
                        class="avatar-img"
                        width="30"
                        height="30"
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Good morning Brian, I hope you can help with the
                          following. I am looking for somebody who can help us
                          create stronger newsletters.</small
                        >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          ...
                          payment to appear in the Activity section of your
                          account.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Welcome to CookieYes! Thank you for creating an
                          account with us.</small
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Thank you so much for continuing to leave no stone
                          unturned in pursuit of new milestones of
                          success.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Our office will be closed on these days, as it will
                          also be on Friday 6 May.</small
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >We have updated our external meeting and events
                          protocol. Please have a look at the office
                          board.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Happy with your product or service? Sign up for the
                          IONOS Referral Program to recommend us to your
                          business partners, friends or family. We'll reward you
                          with attractive commissions when they place an
                          order.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Please add video overlay option to microsite header
                          image</small
                        >
                      </div>
                    </div>
                ...
                >
                  <div class="d-flex">
                    <div class="avatar avatar-circle avatar-xs me-2">
                      <img
                        src="https://d33wubrfki0l68.cloudfront.net/e83422b2242219796524c41b945eb0a4b4b75dfd/caa0b/assets/images/profiles/profile-08.jpeg"
                        alt="..."
                        class="avatar-img"
                        width="30"
                        height="30"
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >[JIRA] (WEB-1022) Add Full Width Video Content Block
                          to microsites</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Your hard drive is close to its storage cap. Once
                          exceeded, you can't add new items or sync
                          changes.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Login to your Rave account to place your order and
                          you will automatically earn double points on every $
                          spent.</small
                        >
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-secondary"
                          >Improving slide arrows and indicators on gift impact,
                          testimonial and victories module</small
                        >
                      </div>
                    </div>
                  </div>
         ...
         <!--  <div class="dropdown"> -->
           ...
           <!--  <div
              class="dropdown-menu dropdown-menu-end w-300px h-250px overflow-auto scrollbar"
            >
              ...
              <div class="py-4 px-5">
                <div class="row">
                  ...
                  >
                    ...
                    >
                      <span
                        class="avatar avatar-xs d-flex align-items-center mx-auto mb-1"
                      >
                        <svg
                  ...
                  <div
                    class="col-4 d-flex justify-content-center align-items-end"
                  >
                    <a
                      href="javascript: void(0);"
                      class="d-inline-block link-secondary fs-5 fw-semibold text-center p-3"
                  ...
                  >
                    ...
                    >
                      <span
                        class="avatar avatar-sm w-35px h-35px avatar-circle"
                      >
          ...
          <!-- Button -->
         <!--  <a
            class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px link-secondary"
            data-bs-toggle="offcanvas"
          ...
          >
            <div class="offcanvas-body pt-7 pb-5 position-relative">
              <button
                type="button"
                class="btn-close position-absolute top-0 end-0 mt-5 me-5"
                data-bs-dismiss="offcanvas"
                aria-label="Close"
              ></button>
              ...
              <div class="text-center">
                <img
                  ...
                  height="170"
                />
                <h3 class="mb-2" id="offcanvasCustomizeTitle">
              ...
              <div
                class="btn-group w-100 mb-7"
                role="group"
                aria-label="Light/dark switcher"
              >
                <input
                  type="radio"
                  class="btn-check"
              ...
              <div
                class="btn-group w-100 mb-7"
                role="group"
                aria-label="Navigation color switcher"
              >
                <input
                  type="radio"
                  class="btn-check"
              ...
              <div
                class="btn-group w-100 mb-7"
                role="group"
                aria-label="Sidebar layout switcher"
              >
                <input
                  type="radio"
                  class="btn-check"
              ...
              >
                ...
                <div class="form-check form-switch mb-0">
                  <input
                    ...
                    id="isFluid"
                    aria-label="Fluid layout switcher"
                    checked=""
                  />
                </div>
              </div>
            ...
            <div class="dropdown-menu">
              ...
              <div class="dropdown dropend">
                ...
                >
                  ...
                  <a class="dropdown-item" href="javascript: void(0);">
                    <span class="legend-circle bg-gray-500 me-2"></span>Appear
                    offline
                  </a>
                  <hr class="dropdown-divider" />
                  <a class="dropdown-item" href="javascript: void(0);">
