                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card-body p-0">
                                <h5>Envío gratis</h5>
                                <p class="card-text">Contamos con envío gratis hasta la comodidad de tu domicilio sin costo extra (en compras mayores a $2,000 MXN).</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card-body p-0">
                                ...
                                <p class="card-text">Realiza tus compras con total confianza.
                                    Contamos con encriptación avanzada para proteger tus datos y garantizar transacciones seguras.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card-body p-0">
                                ...
                                <p class="card-text">Orgullosos de ofrecerte los productos de la prestigiosa marca Sayer, reconocida por su calidad y durabilidad. Encuentra soluciones confiables para tus proyectos.</p>
            ...
            <div class="col">
                <div class="card mb-3 border-0">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card-body p-0">
                                <h5>Ofertas todos los días</h5>
                                <p class="card-text">Aprovecha precios irresistibles y descuentos exclusivos cada día. Renueva tus proyectos sin gastar de más.</p>
