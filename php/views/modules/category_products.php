...
if (!isset($_GET['filter'])  || $_GET['cat'] == '') {
    echo '<script>window.location.href = "index.php";</script>';
    exit; // Detener la ejecución del script después de redirigir
}
ob_end_flush(); // Libera el contenido del buffer (si es necesario)

$getCategory = $prods_model->getCategory($_GET['cat']);
$category = "";
if (!empty($getCategory)) {
    $getCategory = $getCategory[0];
    $category = $getCategory->categories_description;
}
?>
<section class="py-5">
            ...
            <div class="col-md-12">
                ...
                <div class="bootstrap-tabs product-tabs">
                    <div class="tabs-header d-flex justify-content-between border-bottom my-5">
                        <h3>Productos de la categoría <?= $category ?></h3>
                        <!-- <nav>
...
<script src="js/functions/loadCategoryProducts.js"></script>